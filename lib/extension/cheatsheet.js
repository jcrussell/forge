...
export class Cheatsheet extends GObject.Object {
  ...
  /** @type {number} signal id for global.display::monitors-changed (0 = none) */
  ...
  show() {
    ...
    // again would trip Clutter's single-parent invariant (forge-v3y3).
    ...
    if (!this._monitorsChangedId) {
      this._monitorsChangedId = global.display.connect("monitors-changed", () => this._recenter());
    }
