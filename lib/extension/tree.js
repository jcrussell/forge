...
// Divisor that scales the border+gap contribution into the stacked/tabbed
// decoration's width/x/y adjustments (forge-u8ni). Empirically tuned to keep
// the header strip aligned with the bordered content below it.
...
export class Tree extends Node {
  ...
  _applyDecorationRect(node, child, params, barSize, tabExpand) {
    ...
    let adjustY = gap === 0 ? renderRect.y : renderRect.y - adjust;
