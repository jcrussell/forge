...
export class Tree extends Node {
  ...
  // forge-s6g: minimum size of a child in the split orientation. Only WINDOW
  // nodes carry size hints; CON children and hint-less windows contribute 0.
  _minSizeInOrientation(childNode, orientation) {
    if (!childNode.isWindow() || !childNode.nodeValue) return 0;
    const hints = childNode.nodeValue.get_size_hints?.();
    if (!hints) return 0;
