...
export class Keybindings extends GObject.Object {
  ...
  listenFor(accelerator, callback) {
    ...
    if (action == Meta.KeyBindingAction.NONE) {
      ...
      // Notify user about the keybinding conflict
      Main.notify(
        "Forge Keybinding Conflict",
        `Unable to bind "${accelerator}". It may conflict with another application or GNOME Shell keybinding.`,
      );
    } else {
